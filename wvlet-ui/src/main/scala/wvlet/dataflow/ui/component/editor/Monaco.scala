...
//      def fragment: String                              = js.native
    ...
    class Selection protected () extends Range {
      def this(selectionStartLineNumber: Double,
               selectionStartColumn: Double,
               positionLineNumber: Double,
               positionColumn: Double) = this()
      def selectionStartLineNumber: Double                                                   = js.native
      def selectionStartColumn: Double                                                       = js.native
      def positionLineNumber: Double                                                         = js.native
      def positionColumn: Double                                                             = js.native
    ...
    object Selection extends js.Object {
      ...
      def createWithDirection(startLineNumber: Double,
                              startColumn: Double,
                              endLineNumber: Double,
                              endColumn: Double,
                              direction: SelectionDirection): Selection = js.native
    }
    ...
    package editor {
      ...
      import wvlet.dataflow.ui.component.editor.importedjs.monaco.editor.Editor.{
        BuiltinTheme,
...
//                        limitResultCount: Double = ???): js.Array[FindMatch] = js.native
        def findNextMatch(searchString: String,
                          ...
                          matchCase: Boolean,
                          wordSeparators: String | Null,
                          captureMatches: Boolean): FindMatch | Null = js.native
        def findPreviousMatch(searchString: String,
                              searchStart: IPosition,
                              isRegex: Boolean,
                              matchCase: Boolean,
                              wordSeparators: String | Null,
        ...
        def deltaDecorations(oldDecorations: js.Array[String],
                             newDecorations: js.Array[IModelDeltaDecoration],
                             ownerId: Double = ???): js.Array[String]        = js.native
        ...
        def getLineDecorations(lineNumber: Double,
                               ownerId: Double = ???,
                               filterOutValidation: Boolean = ???): js.Array[IModelDecoration] = js.native
        def getLinesDecorations(startLineNumber: Double,
                                endLineNumber: Double,
                                ownerId: Double = ???,
                                filterOutValidation: Boolean = ???): js.Array[IModelDecoration] = js.native
        def getDecorationsInRange(range: IRange,
                                  ownerId: Double = ???,
                                  filterOutValidation: Boolean = ???): js.Array[IModelDecoration] = js.native
        def getAllDecorations(ownerId: Double = ???, filterOutValidation: Boolean = ???): js.Array[IModelDecoration] =
          js.native
        def getOverviewRulerDecorations(ownerId: Double = ???,
                                        filterOutValidation: Boolean = ???): js.Array[IModelDecoration] = js.native
        ...
        def pushEditOperations(beforeCursorState: js.Array[Selection],
                               editOperations: js.Array[IIdentifiedSingleEditOperation],
                               cursorStateComputer: ICursorStateComputer): js.Array[Selection] | Null = js.native
        ...
        def onDidChangeLanguageConfiguration(
            listener: js.Function1[IModelLanguageConfigurationChangedEvent, Unit]): IDisposable = js.native
      ...
      trait IEditor extends js.Object {
        ...
        def revealLinesInCenter(lineNumber: Double, endLineNumber: Double, scrollType: ScrollType = ???): Unit =
          js.native
        def revealLinesInCenterIfOutsideViewport(lineNumber: Double,
                                                 endLineNumber: Double,
                                                 scrollType: ScrollType = ???): Unit                = js.native
      ...
      trait ICodeEditor extends IEditor {
        ...
        def executeEdits(source: String,
                         edits: js.Array[IIdentifiedSingleEditOperation],
                         endCursorState: ICursorStateComputer | js.Array[Selection] = ???): Boolean = js.native
        ...
        def deltaDecorations(oldDecorations: js.Array[String],
                             newDecorations: js.Array[IModelDeltaDecoration]): js.Array[String] = js.native
      ...
      object Editor extends js.Object {
        def create(domElement: HTMLElement,
                   options: IStandaloneEditorConstructionOptions = ???,
                   `override`: IEditorOverrideServices = ???): IStandaloneCodeEditor  = js.native
        def onDidCreateEditor(listener: js.Function1[ICodeEditor, Unit]): IDisposable = js.native
        def createDiffEditor(domElement: HTMLElement,
                             options: IDiffEditorConstructionOptions = ???,
                             `override`: IEditorOverrideServices = ???): IStandaloneDiffEditor = js.native
    ...
    package languages {
      ...
      import wvlet.dataflow.ui.component.editor.importedjs.monaco.Monaco.Thenable
      import wvlet.dataflow.ui.component.editor.importedjs.monaco.languages.Languages.{
        CharacterPair,
        Definition,
      ...
      trait CodeActionProvider extends js.Object {
        def provideCodeActions(model: editor.ITextModel,
                               range: Range,
                               context: CodeActionContext,
                               token: CancellationToken): ProviderResult[CodeActionList] = js.native
      }
      ...
      trait HoverProvider extends js.Object {
        def provideHover(model: editor.ITextModel,
                         position: Position,
                         token: CancellationToken): ProviderResult[Hover] = js.native
      }
      ...
      trait CompletionItemProvider extends js.Object {
        ...
        def provideCompletionItems(model: editor.ITextModel,
                                   position: Position,
                                   context: CompletionContext,
                                   token: CancellationToken): ProviderResult[CompletionList] = js.native
        def resolveCompletionItem(model: editor.ITextModel,
                                  position: Position,
                                  item: CompletionItem,
                                  token: CancellationToken): ProviderResult[CompletionItem] = js.native
      }
      ...
      trait SignatureHelpProvider extends js.Object {
        ...
        def provideSignatureHelp(model: editor.ITextModel,
                                 position: Position,
                                 token: CancellationToken,
                                 context: SignatureHelpContext): ProviderResult[SignatureHelpResult] = js.native
      }
      ...
      trait DocumentHighlightProvider extends js.Object {
        def provideDocumentHighlights(model: editor.ITextModel,
                                      position: Position,
                                      token: CancellationToken): ProviderResult[js.Array[DocumentHighlight]] = js.native
      }
      ...
      trait ReferenceProvider extends js.Object {
        def provideReferences(model: editor.ITextModel,
                              position: Position,
                              context: ReferenceContext,
                              token: CancellationToken): ProviderResult[js.Array[Location]] = js.native
      }
      ...
      trait DefinitionProvider extends js.Object {
        def provideDefinition(model: editor.ITextModel,
                              position: Position,
                              token: CancellationToken): ProviderResult[Definition | js.Array[LocationLink]] = js.native
      }

      @js.native
      trait DeclarationProvider extends js.Object {
        def provideDeclaration(model: editor.ITextModel,
                               position: Position,
                               token: CancellationToken): ProviderResult[Definition | js.Array[LocationLink]] =
          js.native
      }

      @js.native
      trait ImplementationProvider extends js.Object {
        def provideImplementation(model: editor.ITextModel,
                                  position: Position,
                                  token: CancellationToken): ProviderResult[Definition | js.Array[LocationLink]] =
          js.native
      }
      ...
      trait TypeDefinitionProvider extends js.Object {
        def provideTypeDefinition(model: editor.ITextModel,
                                  position: Position,
                                  token: CancellationToken): ProviderResult[Definition | js.Array[LocationLink]] =
          js.native
      }
      ...
      trait DocumentSymbolProvider extends js.Object {
        ...
        def provideDocumentSymbols(model: editor.ITextModel,
                                   token: CancellationToken): ProviderResult[js.Array[DocumentSymbol]] = js.native
      }
      ...
      trait DocumentFormattingEditProvider extends js.Object {
        ...
        def provideDocumentFormattingEdits(model: editor.ITextModel,
                                           options: FormattingOptions,
                                           token: CancellationToken): ProviderResult[js.Array[TextEdit]] = js.native
      }

      @js.native
      trait DocumentRangeFormattingEditProvider extends js.Object {
        def displayName: String = js.native
        def provideDocumentRangeFormattingEdits(model: editor.ITextModel,
                                                range: Range,
                                                options: FormattingOptions,
                                                token: CancellationToken): ProviderResult[js.Array[TextEdit]] =
          js.native
      }
      ...
      trait OnTypeFormattingEditProvider extends js.Object {
        ...
        def provideOnTypeFormattingEdits(model: editor.ITextModel,
                                         position: Position,
                                         ch: String,
                                         options: FormattingOptions,
                                         token: CancellationToken): ProviderResult[js.Array[TextEdit]] = js.native
      ...
      trait DocumentColorProvider extends js.Object {
        def provideDocumentColors(model: editor.ITextModel,
                                  token: CancellationToken): ProviderResult[js.Array[IColorInformation]] = js.native
        def provideColorPresentations(model: editor.ITextModel,
                                      colorInfo: IColorInformation,
                                      token: CancellationToken): ProviderResult[js.Array[IColorPresentation]] =
          js.native
      }
      ...
      trait SelectionRangeProvider extends js.Object {
        def provideSelectionRanges(model: editor.ITextModel,
                                   positions: js.Array[Position],
                                   token: CancellationToken): ProviderResult[js.Array[js.Array[SelectionRange]]] =
          js.native
      }
      ...
      trait FoldingRangeProvider extends js.Object {
        def provideFoldingRanges(model: editor.ITextModel,
                                 context: FoldingContext,
                                 token: CancellationToken): ProviderResult[js.Array[FoldingRange]] = js.native
      }
      ...
      trait RenameProvider extends js.Object {
        def provideRenameEdits(model: editor.ITextModel,
                               position: Position,
                               newName: String,
                               token: CancellationToken): ProviderResult[WorkspaceEdit with Rejection] = js.native
        def resolveRenameLocation(model: editor.ITextModel,
                                  position: Position,
                                  token: CancellationToken): ProviderResult[RenameLocation with Rejection] = js.native
      }
      ...
      trait CodeLensProvider extends js.Object {
        ...
        def provideCodeLenses(model: editor.ITextModel, token: CancellationToken): ProviderResult[CodeLensList] =
          js.native
        def resolveCodeLens(model: editor.ITextModel,
                            codeLens: CodeLens,
                            token: CancellationToken): ProviderResult[CodeLens] = js.native
      }
      ...
      trait DocumentSemanticTokensProvider extends js.Object {
        ...
        def provideDocumentSemanticTokens(
            ...
            token: CancellationToken): ProviderResult[SemanticTokens | SemanticTokensEdits] = js.native
      ...
      trait DocumentRangeSemanticTokensProvider extends js.Object {
        def getLegend(): SemanticTokensLegend = js.native
        def provideDocumentRangeSemanticTokens(model: editor.ITextModel,
                                               range: Range,
                                               token: CancellationToken): ProviderResult[SemanticTokens] = js.native
      }
      ...
      package typescript {
        ...
        import wvlet.dataflow.ui.component.editor.importedjs.monaco.languages.typescript.Typescript.CompilerOptionsValue
        ...
        trait TypeScriptWorker extends js.Object {
          ...
          def getFormattingEditsForRange(fileName: String,
                                         start: Double,
                                         end: Double,
                                         options: js.Any): Promise[js.Array[js.Any]] = js.native
          def getFormattingEditsAfterKeystroke(fileName: String,
                                               postion: Double,
                                               ch: String,
                                               options: js.Any): Promise[js.Array[js.Any]]       = js.native
          ...
          def getCodeFixesAtPosition(fileName: String,
                                     start: Double,
                                     end: Double,
                                     errorCodes: js.Array[Double],
                                     formatOptions: js.Any): Promise[js.Array[_ <: js.Any]] = js.native
        }

        @js.native
        @JSGlobal("monaco.languages.typescript")
        object Typescript extends js.Object {
          type CompilerOptionsValue = String | Double | Boolean | js.Array[String | Double] | js.Array[String] | MapLike[
      ...
      object Languages extends js.Object {
        ...
        def setMonarchTokensProvider(languageId: String,
                                     languageDef: IMonarchLanguage | Thenable[IMonarchLanguage]): IDisposable =
          js.native
        ...
        def registerDocumentFormattingEditProvider(languageId: String,
                                                   provider: DocumentFormattingEditProvider): IDisposable = js.native
        def registerDocumentRangeFormattingEditProvider(languageId: String,
                                                        provider: DocumentRangeFormattingEditProvider): IDisposable =
          js.native
        def registerOnTypeFormattingEditProvider(languageId: String,
                                                 provider: OnTypeFormattingEditProvider): IDisposable = js.native
        ...
        def registerSelectionRangeProvider(languageId: String, provider: SelectionRangeProvider): IDisposable =
          js.native
        def registerDocumentSemanticTokensProvider(languageId: String,
                                                   provider: DocumentSemanticTokensProvider): IDisposable = js.native
        def registerDocumentRangeSemanticTokensProvider(languageId: String,
                                                        provider: DocumentRangeSemanticTokensProvider): IDisposable =
          js.native
        ...
        type IMonarchLanguageAction = IShortMonarchLanguageAction | IExpandedMonarchLanguageAction | js.Array[
          IShortMonarchLanguageAction] | js.Array[IExpandedMonarchLanguageAction]
      }
