...
import org.scalajs.dom.{KeyboardEvent, MouseEvent, Element}
import org.scalajs.dom.raw.HTMLElement

import facade.monaco.editor.Editor.{
  BuiltinTheme,
  IColors,
  IEditorModel,
  IEditorViewState,
...
import facade.monaco.languages.Languages.{CharacterPair, ProviderResult, Definition, TextEdit}
import facade.monaco.languages.Languages.{IMonarchLanguageRule, IMonarchLanguageAction}
...
package facade {
  package monaco {
    ...
    class Promise[T] protected () extends js.Object {
      def this(executor: js.Function2[js.Function1[T | js.Thenable[T], Unit], js.Function1[js.Any, Unit], Unit]) =
        this()
      def `then`[TResult1, TResult2](
          onfulfilled: js.Function1[T, TResult1 | js.Thenable[TResult1]] | Null = ???,
          onrejected: js.Function1[js.Any, TResult2 | js.Thenable[TResult2]] | Null = ???
    ...
    object Promise extends js.Object {
      ...
      def join[T1, T2](promises: js.Tuple2[T1 | js.Thenable[T1], T2 | js.Thenable[T2]]): Promise[js.Tuple2[T1, T2]] =
        js.native
    ...
    package editor {
      ...
      trait ICodeEditor extends IEditor {
        ...
        var editorOptions: InternalEditorOptions                                              = js.native
    ...
    package languages {
      ...
      trait CodeActionProvider extends js.Object {
        ...
        ): js.Array[Command | CodeAction] | Thenable[js.Array[Command | CodeAction]] =
          js.native
      }
      ...
      trait LinkProvider extends js.Object {
        def provideLinks(model: editor.ITextModel, token: CancellationToken): ProviderResult[js.Array[ILink]] =
          js.native
      ...
      trait CodeLensProvider extends js.Object {
        ...
        def provideCodeLenses(
            model: editor.ITextModel,
            token: CancellationToken
        ): ProviderResult[js.Array[ICodeLensSymbol]] = js.native
        def resolveCodeLens(
            model: editor.ITextModel,
            codeLens: ICodeLensSymbol,
            token: CancellationToken
        ): ProviderResult[ICodeLensSymbol] = js.native
      }
      ...
      object Languages extends js.Object {
        ...
        def setTokensProvider(languageId: String, provider: TokensProvider | EncodedTokensProvider): IDisposable =
          js.native
